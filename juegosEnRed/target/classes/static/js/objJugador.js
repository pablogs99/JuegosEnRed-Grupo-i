function Jugador(dir, personajeData, addM) {
  ...
  this.frameAction = {
    // Tiempo que tarda en completar la acción
  ...
  this.accion = {
    // Controlador que comprueba si una acción se esta realizando
    salto: false,
    ataque: false,
    herido: false,
    protege: false,
  ...
  this.createAnimations = function (escena) {
    ...
    escena.anims.create({
      ...
      frames: escena.anims.generateFrameNames(this.personaje + "Iddle", {
        start: 0,
        end: personajeData.limiteAnimacion.iddle,
      }),
      frameRate: 5,
      repeat: -1,
    });
    ...
    escena.anims.create({
      ...
      frames: escena.anims.generateFrameNames(this.personaje + "Salto", {
        start: 0,
        end: personajeData.limiteAnimacion.salto,
      }),
      frameRate: 5,
      repeat: 0,
    });
    ...
    escena.anims.create({
      ...
      frames: escena.anims.generateFrameNames(this.personaje + "Ataque", {
        start: 0,
        end: personajeData.limiteAnimacion.ataque,
      }),
      frameRate: 15,
      repeat: 1,
    });
    ...
    escena.anims.create({
      ...
      frames: escena.anims.generateFrameNames(this.personaje + "Defiende", {
        start: 0,
        end: personajeData.limiteAnimacion.defiende,
      }),
      frameRate: 0,
      repeat: 1,
    });
    ...
    escena.anims.create({
      ...
      frames: escena.anims.generateFrameNames(this.personaje + "Muerte", {
        start: 0,
        end: personajeData.limiteAnimacion.muerte,
      }),
      frameRate: 5,
      repeat: 1,
    });
    ...
    escena.anims.create({
      ...
      frames: escena.anims.generateFrameNames(this.personaje + "Corre", {
        start: 0,
        end: personajeData.limiteAnimacion.corre,
      }),
      frameRate: 5,
      repeat: 1,
    });
    ...
    escena.anims.create({
      ...
      frames: escena.anims.generateFrameNames(this.personaje + "Herido", {
        start: 0,
        end: personajeData.limiteAnimacion.herido,
      }),
      frameRate: 5,
      repeat: 1,
    });
  ...
  this.setSprite = function (escena) {
    ...
    this.sprite
      .setSize(
        personajeData.sizeHitbox.width,
        personajeData.sizeHitbox.height,
        false
      )
      .setOffset(personajeData.actualizarSpriteDerecha, 0);
    this.sprite.depth = 1;
    ...
    this.hitbox
      .setSize(
        personajeData.sizeArma.width,
        personajeData.sizeArma.height,
        false
      )
      .setOffset(personajeData.armaOffSet.x, personajeData.armaOffSet.y);
    this.hitbox.depth = 1;
  ...
  this.playAnimation = function (escena) {
    if (!this.accion.muerte) {
      ...
      this.hitbox.x =
        this.sprite.x + personajeData.armaActualizar.x * this.direccion;
      ...
      if (this.accion.protege) {
        ...
        if (this.energia < 100) {
          this.energia += personajeData.aumentoEnergia;
        }
      }
    } else {
      this.sprite.anims.play(this.animacionActual, true);
