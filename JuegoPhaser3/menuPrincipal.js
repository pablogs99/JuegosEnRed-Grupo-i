class menuPrincipal extends Phaser.Scene {
  ...
  preload() {
    this.load.image("portada", "../imagenes/portadaSolo.png");
    this.load.image("jugar", "../imagenes/jugarBoton.png");
    this.load.image("ajustes", "../imagenes/ajustesBoton.png");
    this.load.image("rayaAmarilla", "../imagenes/raya.png")
    this.load.image("soundOn", "../imagenes/soundOn.png")
    this.load.image("soundOff", "../imagenes/soundOff.png")

	  this.load.audio("musicaInicio","../audio/theme-of-wargroove.mp3");
  }
